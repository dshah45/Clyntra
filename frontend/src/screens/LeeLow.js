...
function Seller({match}) {
  ...
  useEffect(() => {
    async function fetchProducts() {
      const { data } = await axios.get("http://127.0.0.1:8000/api/leelow/");
      setProducts(data);
    }
    fetchProducts();
  }, []);
  return (
    ...
    <br />
      ...
      <Row>
        ...
        <br />
        <br />
        <Link style={{ textDecoration: 'none' }} to="/leeview">Top Viewed Products <i class="fa fa-eye" aria-hidden="true"></i>
    </Link>
       </Row>
       </Col>
