import { USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_LOGIN_FAIL, USER_LOGOUT,
    ...
    USER_DETAILS_REQUEST, USER_DETAILS_SUCCESS, USER_DETAILS_FAIL,USER_DETAILS_RESET,USER_DELETE_REQUEST,
...
export const contact = (name, email, query) => async (dispatch) => {
    try {
        dispatch({
